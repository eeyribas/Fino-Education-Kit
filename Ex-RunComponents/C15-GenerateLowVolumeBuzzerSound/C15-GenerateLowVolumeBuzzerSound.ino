// Example code for generating lower volume sound from the buzzer.
...
void loop()
{
// It enables sound output from the buzzer. The value 2000 in the code represents a sound with a frequency of 2 kHz.
  fino.StartBuzzer(2000);
