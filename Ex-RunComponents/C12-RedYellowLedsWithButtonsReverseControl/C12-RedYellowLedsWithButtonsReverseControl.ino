// Example code for lighting up the yellow LED and turning off the red LED 
// when the top button is pressed, and turning off the yellow LED and lighting up 
// the red LED when the bottom button is pressed.
